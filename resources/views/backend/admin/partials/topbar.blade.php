    ...
    <div class="page-wrapper__topbar--linkRight">
        ...
        <div class="box-user">
            ...
            <div class="user-link">
                ...
                <a href="#" class="link"><i class="fa fa-lock" aria-hidden="true"></i>Mot de passe</a>
                <hr class="underline" />
                <a href="{{ route('deconnexion-admin') }}" class="link"><i class="fa fa-sign-out" aria-hidden="true"></i>Déconnexion</a>
            </div>
        </div>
    </div>
</div>