@extends('backend/eleve/layout/default_enseignant', ['title' => "CEL || Compte CelPay"])
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('enseignant-rechargement-celpay') }}" class="form-row form-note" id="form_rechargement_celpay">
                        {{ csrf_field() }}
    ...
    <div class="modal fade modalBlack" id="modalTransfert" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('enseignant-transfert-celpay') }}" class="form-row form-note" id="form_transfert_celpay">
                        {{ csrf_field() }}
                        <div class="col-12 col-md-6">
                            <div class="form--group">
