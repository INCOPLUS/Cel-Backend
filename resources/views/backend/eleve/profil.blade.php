@extends('backend/eleve/layout/default', ['title' => "CEL || Mon profil"])
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-lg-8">
                                <div class="box-infor">
                                    ...
                                    <div class="min-banner">
                                        <p class="paragraph">Université Virtuelle de Côte d'Ivoire</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4">
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="box-infor">
                                    ...
                                    <div class="min-banner">
                                        <p class="paragraph">10/02/1998</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4">
