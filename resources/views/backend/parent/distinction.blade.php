@extends('backend/parent/layout/default', ['title' => "CEL || Distinctions"])
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="card-distinction">
                                        <div class="img-illust"><img src="../images/badge.svg" alt="badge"></div>
                    ...
                    <div class="tab-pane fade" id="tabs2" role="tabpanel" aria-labelledby="tabs2-tab">
                        <div class="content">
                            <div class="row">
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="card-distinction">
                                        <div class="img-illust"><img src="../images/trophe.svg" alt="cup"></div>
                                        <div class="content-th">
                                            <div class="top">
                    ...
                    <div class="tab-pane fade" id="tabs3" role="tabpanel" aria-labelledby="tabs3-tab">
                        <div class="content">
                            <div class="row">
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="card-distinction">
                                        <div class="img-illust"><img src="../images/cup.svg" alt="cup"></div>
                                        <div class="content-th">
                                            <div class="top">
                    ...
                    <div class="tab-pane fade" id="tabs4" role="tabpanel" aria-labelledby="tabs4-tab">
                        <div class="content">
                            <div class="row">
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="card-distinction">
                                        <div class="img-illust"><img src="../images/success.svg" alt="success"></div>
                                        <div class="content-th">
                                            <div class="top">
