...
<head>
    ...
    <title>CEL || Connexion - Administrateur</title>
        ...
        <div class="container">
            <div class="sign-general-content --login">
                ...
                <div class="box-form-sign">
                    ...
                    <p class="paragraph-site"><a href="#">Connectez-vous</a></p>
                    <form class="form-row form-sign" id="form_connexion" action="{{ route('connexion-admin') }}" method="POST">
                        <div class="col-lg-12">
